    ...
    def analyze(self, events: List[Dict]) -> List[Dict]:
        ...
        if anomalies == 0:
            ...
            if not smc_events:
                return []
            evidence = [
                f"Logical sessions analysed: {len(sessions)} (from {len(sessions)} NAS state machines)",
            ...
            findings.append(make_finding(
                ...
                description=(
                    f"Across {len(sessions)} logical NAS sessions and "
        ...
        findings.append(make_finding(
            ...
            description=(
                ...
                f"{len(sessions)} logical NAS sessions: {len(eea0_smcs)} EEA0 SMC selection(s), "
