...
NAS_MSG_TYPES = {
    ...
    0xD1: "Activate Default EPS Bearer Context Request",
    0xD2: "Activate Default EPS Bearer Context Accept",
    0xD3: "Activate Default EPS Bearer Context Reject",
    0xE1: "PDN Disconnect Request",
